 ...
 */
    S_API s_u64 s_dram_read64bits(s_u64 p_addr);
 ...
 * @param cr active cpu core processor
 */
    S_API void s_dram_write64bits(s_u64 p_addr, s_u64 data);
 ...
 * @param cr active cpu core processor
 */
    S_API void s_dram_read_inst(s_u64 p_addr, s_str_t *buf);
 ...
 * @param cr active cpu core processor
 */
    S_API void s_dram_write_inst(s_u64 p_addr, s_str_t *str);
 ...
 */
    S_API s_u64 s_va2pa(s_u64 v_addr);
