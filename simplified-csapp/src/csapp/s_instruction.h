 ...
 * CPU.
 */
    S_API void s_instruction_cycle();
 ...
 */
    S_API void s_inst_parse_instruction(s_str_t *str, s_inst_t *inst);
 ...
 */
    S_API void s_inst_parse_operand(s_str_t *opr_str, s_inst_operand_t *od);
