...
#include <csapp/s_macros.h>
    ...
    S_API s_list_t      *s_list_create(s_size capacity, s_size elt_size);
    S_API void           s_list_init(s_list_t *list, s_size capacity, s_size elt_size);
    S_API s_list_node_t *s_list_node_create(s_size size);
